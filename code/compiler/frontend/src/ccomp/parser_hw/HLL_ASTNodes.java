...
public class HLL_ASTNodes {
  ...
  public static class StructTypeSpecification extends TypeSpecification implements Declaration{
    String structType;
    String structName; 
  ...
  public static class CompoundStatement implements Statement {
    ...
    public CompoundStatement(ArrayList<Declaration> declarations, ArrayList<Statement> statements) {
  ...
  public static class LoopStatement implements Statement {
    ...
    public LoopStatement(Statement pre, Expression enter, Statement block, Statement advance) {
      ...
      this.block = new CompoundStatement(new ArrayList(), block2);
    }
  }
  ...
  public static class FunctionDefinition {
    ...
    public FunctionDefinition(Identifier functionNameAndArgs, Statement block) {
      ...
      this.returnType = new TypeSpecification("int");
      this.block = block;
    }
  }
