...
#define DIRECTORY_PERMISSION ((S_IRWXU | S_IRWXO | S_IRWXG) & ~(S_IWOTH | S_IWGRP))
...
typedef CircuitData<mpz_t> CircuitMPZData;
typedef CircuitData<mpq_t> CircuitMPQData;
